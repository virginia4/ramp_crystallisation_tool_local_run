 # -*- coding: utf-8 -*-
from app_dir import app, app_home, app_initial_cond_grid_LT, app_initial_cond_lhs, opti_models, app_notes_and_tips, app_database
...
def display_page(pathname):
    ...
    if pathname.endswith('/grid/'):
        return app_initial_cond_grid_LT.layout
