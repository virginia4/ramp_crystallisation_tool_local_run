...
# <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K9T4MD7"
...
layout = [
    html.Iframe(src="https://www.googletagmanager.com/ns.html?id=GTM-K9T4MD7",
        height="0", width="0", style=dict(border=0)),
    html.Div(
        [
            ...
            html.Div(
                html.Ol([
                    html.Li(html.A('Compute initial condition with grid', href='/grid/')),
                    html.Li(html.A('Optimise screen using latin hypercube sampling', href='/lhs/'))
                ]),
                className="sycolinks"),
            # html.P([
            #     "Find the code ",
